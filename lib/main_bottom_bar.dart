              ...
              if (allowChangeColor) ...[
                Expanded(
                  child: Slider(
                    ...
                    inactiveColor:
                        Colors.brown.withOpacity(0.3), // Dim the inactive part
                  ),
                ),
                FloatingActionButton(
                  backgroundColor: Colors.red, // Use red color for background
                ...
                Text(
                  ('Value for R (Red): ${redSliderValue.toStringAsFixed(0)}'),
          ...
          Row(
            ...
            children: [
              if (allowChangeColor) ...[
                ...
                Text(
                  ('Value for G (Green): ${greenSliderValue.toStringAsFixed(0)}'),
          ...
          Row(
            ...
            children: [
              if (allowChangeColor) ...[
                ...
                Text(
                  ('Value for B (Blue): ${blueSliderValue.toStringAsFixed(0)}'),
